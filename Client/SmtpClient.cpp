...
int main(int argc, char** argv)
{
    ...
    /////////////////////////////////////////////////
    server.server = "smpts://smtp.gmail.com";
    server.port = "465";
    server.user = "bhendeaditya2@gmail.com";
    server.password = "wxkydzefvhyhtqig";

    data.filename = "myfile.txt";
    data.filepath = "/home/bom/myfile.txt";
    data.from_email = "bhendeaditya2@gmail.com";

    data.to_email.push_back("bhendeaditya2@gmail.com");
    data.to_email.push_back("bhendeaditya2@gmail.com");
